...
public:
	explicit BattleInfoForm(__int64 index, QWidget* parent);
...
private slots:
	...
	void onNotifyBattleActionState(__int64 index, bool left);

	void onBattleTableItemForegroundColorChanged(__int64 index, const QColor& color);
