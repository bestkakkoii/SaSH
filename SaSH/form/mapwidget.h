...
class MapWidget : public QMainWindow, public Indexer
{
	Q_OBJECT;
public:
	explicit MapWidget(__int64 index, QWidget* parent);

	virtual ~MapWidget();

signals:
	void on_close(__int64 index);
...
private:
	...
	__int64 downloadMapXSize_ = 0;
	__int64 downloadMapYSize_ = 0;
	...
	static QHash<__int64, QHash<QPoint, QString>> entrances_;
	...
	const __int64 boundaryWidth_ = 1;
