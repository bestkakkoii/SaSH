...
qint64 CLuaSystem::set(std::string enumStr, sol::object p1, sol::object p2, sol::object p3, sol::object p4, sol::object p5, sol::object p6, sol::object p7, sol::this_state s)
{
	...
	if (type == util::kBattleCharNormalActionTypeValue)
	{
		...
		qint64 value2 = p2.as<qint64>();
		--value2;
		if (value2 < 0)
			value2 = 0;

		qint64 value3 = p3.as<qint64>();
		--value3;
		if (value3 < 0)
			value3 = 0;
	...
	case util::kLockPetScheduleEnable:
	{
		...
		QString text = QString::fromUtf8(p2.as<std::string>().c_str());
	...
	case util::kBattleCharRoundActionRoundValue:
	{
		...
		qint64 value4 = p4.as<qint64>();
		--value4;
		if (value4 < 0)
			value4 = 0;

		qint64 value5 = p5.as<qint64>();
		if (value5 < 0)
	...
	case util::kBattleCatchPetNameString:
	{
		...
		if (!p1.is<std::string>())
		{
			...
			text = QString::number(p1.as<qint64>());
		}
		else
			text = QString::fromUtf8(p1.as<std::string>().c_str());
