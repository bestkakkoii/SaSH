...
private:
	...
	QVector<__int64>getColorList() const { QReadLocker locker(&m_stringlistLocker); return m_colorlist; }
	void setColorList(const QVector<__int64>& list) { QWriteLocker locker(&m_stringlistLocker); m_colorlist = list; }

	void getAllList(QVector<QString>& list, QVector<__int64>& colorlist) const { QReadLocker locker(&m_stringlistLocker); list = m_list; colorlist = m_colorlist; }
	void setAllList(const QVector<QString>& list, const QVector<__int64>& colorlist) { QWriteLocker locker(&m_stringlistLocker); m_list = list; m_colorlist = colorlist; }
