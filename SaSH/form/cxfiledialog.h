...
namespace cx
{
	...
	public:
		...
		//@返回 無
		//@別名 構造(選項, 父窗口)
		file_dialog(long long mode, HWND parent);
	...
	static inline QStringList createOpenFileDialog(const QString& directory = "", const QString& caption = "", HWND parent = nullptr)
	{
	...
	static inline QStringList createOpenDirectoryDialog(const QString& directory = "", const QString& caption = "", HWND parent = nullptr)
	{
		static QStringList empty;
	...
	static inline QStringList createSaveFileDialog(const QString& directory = "", const QString& caption = "", HWND parent = nullptr)
	{
		static QStringList empty;
